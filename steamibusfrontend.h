...
class SteamIBusFrontendModule : public AddonInstance {
public:
    SteamIBusFrontendModule(Instance *instance);
    ~SteamIBusFrontendModule() override;
...
private:
    ...
    std::unique_ptr<IBusConfig> config_;
